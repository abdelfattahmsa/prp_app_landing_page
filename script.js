...
(function () {
  ...
  const translations = {
    en: {
      ...
      'hero.metaD': 'Open Source',
      'oss.badge': 'Open Source',
      'oss.heading': 'Built in the open.',
      'oss.desc': 'PRP is fully open source under the MIT license. Browse the code, contribute, report issues, or fork it for your own projects.',
      'oss.repo': 'GitHub Repo →',
      'oss.wiki': 'Wiki',
      'oss.discussions': 'Discussions',
      'oss.projects': 'Project Board',
      'oss.stat1': 'License',
      'oss.stat2a': 'Public',
      'oss.stat2b': 'Repository',
      'oss.stat3a': 'Active',
      'oss.stat3b': 'Development',
      'tech.title': 'Built With',
      'tech.sub': 'Open technologies we\'re proud to use.',
      'tech.flutter': 'Cross-platform UI',
      'tech.supabase': 'Database & Auth',
      'tech.vercel': 'Deployment',
      'tech.claude': 'AI by Anthropic',
      'tech.github': 'Open Source',
      'tech.alphavantage': 'Market Data',
      'footer.github': 'GitHub',
      'footer.discussions': 'Discussions',
      'footer.ghWiki': 'GitHub Wiki',
    ...
    ar: {
      ...
      'hero.metaD': 'مفتوح المصدر',
      'oss.badge': 'مفتوح المصدر',
      'oss.heading': 'بُنِي في الفضاء المفتوح.',
      'oss.desc': 'PRP مفتوح المصدر بالكامل تحت رخصة MIT. تصفّح الكود وشارك في تطويره أو أبلغ عن أخطاء أو افترقه لمشاريعك الخاصة.',
      'oss.repo': 'مستودع GitHub →',
      'oss.wiki': 'الويكي',
      'oss.discussions': 'النقاشات',
      'oss.projects': 'لوحة المشروع',
      'oss.stat1': 'الرخصة',
      'oss.stat2a': 'عام',
      'oss.stat2b': 'المستودع',
      'oss.stat3a': 'نشط',
      'oss.stat3b': 'التطوير',
      'tech.title': 'مبنيّ باستخدام',
      'tech.sub': 'تقنيات مفتوحة نفخر باستخدامها.',
      'tech.flutter': 'واجهة متعددة المنصّات',
      'tech.supabase': 'قاعدة البيانات والمصادقة',
      'tech.vercel': 'النشر',
      'tech.claude': 'ذكاء اصطناعي من Anthropic',
      'tech.github': 'مفتوح المصدر',
      'tech.alphavantage': 'بيانات السوق',
      'footer.github': 'جيت‌هَب',
      'footer.discussions': 'النقاشات',
      'footer.ghWiki': 'ويكي GitHub',
  ...
  /* ------------------ Reveal on scroll ------------------ */
  function initReveal() {
    const targets = document.querySelectorAll('.feature, .shot, .platform, .section__head, .module, .plan, .doc-card, .tech-pill, .oss-banner');
